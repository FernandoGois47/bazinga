...
<form action="{{route('reward.store')}}" method="POST" class="container mt-4">
    ...
    <div class="mb-3">
        ...
        <input type="textarea" id="disableTextInput" name="description" class="form-control" value="{{old('description')}}">
    </div>
    <div class="mb-3">
        <label for="disableTextInput" class="form-label">Pontos necessários</label>
        <input type="text" id="disableTextInput" name="required_points" class="form-control" value="{{old('required_points')}}">
    </div>
